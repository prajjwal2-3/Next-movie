...
const Maincon = () => {
  ...
  return (
    ...
    <div className=" sm:py-48 sm:px-16 px-8 py-12 absolute z-10 text-white">
    ...
    <div className="sm:w-1/4  sm:text-lg text-xs font-bold my-1 opacity-80 ">{release_date}</div>
     <div className="sm:w-1/4 sm:block hidden sm:text-lg text-xs my-2 opacity-80 ">{overview}</div>
